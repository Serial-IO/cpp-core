...
static_assert(cpp_core::reflection::enumeratorCount<cpp_core::PortEvent>() == 2);
...
static_assert(cpp_core::reflection::enumerator_name_v<cpp_core::PortEvent, 0> == "kDetached");
